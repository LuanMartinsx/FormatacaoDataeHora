...
public class CalculoeDuracao {
		// Calculo data e hora e também a função duration
	public static void main(String[] args) {
		...
		Duration t1 = Duration.between(pastWeekDate.atStartOfDay(), d04.atStartOfDay()); // para começar a 00:00
